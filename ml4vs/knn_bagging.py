...
def objective(space):
    ...
    est = BaggingClassifier(base_estimator=clf, max_samples=0.7,
                            max_features=0.5, n_estimators=10)
    estimators = list()
    estimators.append(('scaler', StandardScaler()))
    estimators.append(('est', est))
...
space = {'n_neighbors': hp.choice("n_neighbors", (1, 2, 3, 4, 5, 6, 7))}
